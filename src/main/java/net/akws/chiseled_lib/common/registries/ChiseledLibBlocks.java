...
import net.akws.chiseled_lib.common.block.PlushieBlock;
...
public class ChiseledLibBlocks {
    ...
    private static Block registerPlushie(String name, Function<AbstractBlock.Settings, Block> blockFactory, AbstractBlock.Settings settings, boolean shouldRegisterItem) {
        ...
        if (shouldRegisterItem) {
            ...
            BlockItem blockItem = new BlockItem(block, new Item.Settings().registryKey(itemKey).component(DataComponentTypes.EQUIPPABLE, EquippableComponent.builder(EquipmentSlot.HEAD).build()));
    ...
    private static RegistryKey<Block> keyOfBlock(String name) {
        return RegistryKey.of(RegistryKeys.BLOCK, ChiseledLib.id(name));
    }

    private static RegistryKey<Item> keyOfItem(String name) {
        return RegistryKey.of(RegistryKeys.ITEM, Identifier.of(ChiseledLib.MOD_ID, name));
    }
